  ...
  while ((match = pattern.exec(text)) !== null) {
    ...
    parts.push(
      <a
        ...
        className="mx-0.5 inline-flex items-center gap-1 rounded-full border border-line bg-canvas-overlay px-2 py-0.5 align-[-3px] font-mono text-xs text-fg hover:border-accent hover:text-accent"
      >
